...
def build_docker_image():
    ...
    try:
        ...
        return {"message": "Docker image built successfully", "image_tags": image.tags}
...
def run_container(data):
    ...
    try:
        ...
        container = docker_client.containers.run(
            ...
            detach=True,
            ports={f"{data.container_port}/tcp": data.host_port},
        )
...
def remove_image(image_name: str):
    try:
        ...
        return {"message": f"{image_name} removed"}
    except Exception as error:
        logger.error(str(error))
        return {"error": str(error)}
...
"""def list_images():
    ...
    try:
        ...
        for image in images:
            ...
            result.append({"image_id": image.short_id, "tags": image.tags})
...
def remove_image(image_name: str):
    ...
    try:
        ...
        return {"image_name": image_name, "message": "Image removed successfully"}
